  ...
  try {
    ...
    const r = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        model: 'gpt-4o-mini',
        messages: [
          { role:'system', content:'You are CrossAI, a Nigerian emergency response assistant. Keep replies brief, helpful, and culturally appropriate.' },
    ...
    const reply = data?.choices?.[0]?.message?.content?.trim() || 'I am here to help with emergency response.';
